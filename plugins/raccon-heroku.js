...
module.exports.run = function() {
    ...
    app.get('*', (req, res) => {
        var response = "<html><head><title>raccoon-heroku.js</title><style>body, html {padding: 0;margin: 0;width: 100%;height: 100%;overflow: hidden;}* {font-family: monospace;color: white;background-color: black;}body {margin-left: 5px;}</style></head><body><h1>plugins/raccoon-heroku.js</h1><p>All requests are processed by the raccon-heroku.js plugin.</p><p>When this is not the desired effect, please check the installed plugins.</p><p>raccoon-heroku.js overwrites all created request handlers by default.</p></body></html>";
        res.send(response);
    });
